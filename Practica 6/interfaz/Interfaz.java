...
public class Interfaz extends JFrame implements ActionListener, TransferenciaListener {
    ...
    private String puertoCad; // Declaración de la variable puertoCad
    ...
    private void creaInterfaz() {
        ...
        campoArchivo = new JTextField(40);
        ...
        panelCentral.setLayout(new GridLayout(3, 1, 10, 10)); // Cambiar a GridLayout para organizar verticalmente
        panelCentral.setBackground(new Color(240, 240, 240));

        // Panel para Conexiones
        JPanel panelConexiones = new JPanel(new BorderLayout());
        panelConexiones.setBackground(new Color(255, 228, 225)); // Color de fondo
        JLabel etiquetaConexiones = new JLabel("Conexiones");
        etiquetaConexiones.setHorizontalAlignment(JLabel.CENTER);
        ...
        panelConexiones.add(etiquetaConexiones, BorderLayout.NORTH);
        panelConexiones.add(scrollConexiones, BorderLayout.CENTER);

        // Panel para Estado
        JPanel panelEstado = new JPanel(new BorderLayout());
        panelEstado.setBackground(new Color(224, 255, 255)); // Color de fondo
        ...
        panelEstado.add(etiquetaEstado, BorderLayout.NORTH);
        panelEstado.add(scrollEstado, BorderLayout.CENTER);

        // Panel para Archivos
        JPanel panelArchivos = new JPanel(new BorderLayout());
        panelArchivos.setBackground(new Color(240, 248, 255)); // Color de fondo
        JLabel etiquetaArchivos = new JLabel("Archivo");
        etiquetaArchivos.setHorizontalAlignment(JLabel.CENTER);
        areaArchivos = new JScrollPane();
        panelArchivos.add(etiquetaArchivos, BorderLayout.NORTH);
        panelArchivos.add(areaArchivos, BorderLayout.CENTER);

        panelCentral.add(panelConexiones);
        panelCentral.add(panelEstado);
        panelCentral.add(panelArchivos);

        JPanel panelInferior = new JPanel();
        panelInferior.setLayout(new GridLayout(2, 1, 5, 5));
